...
public class WeatherAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            holder.textViewNamaKota = (TextView)convertView.findViewById(R.id.tv_textKota);
            holder.textViewTemperatur = (TextView)convertView.findViewById(R.id.tv_textTemp);
            holder.textViewDescription = (TextView)convertView.findViewById(R.id.tv_textDesc);
            convertView.setTag(holder);
        }else {
            holder = (ViewHolder)convertView.getTag();
        }
        holder.textViewNamaKota.setText(mData.get(position).getNama());
        holder.textViewTemperatur.setText(mData.get(position).getTemperture());
